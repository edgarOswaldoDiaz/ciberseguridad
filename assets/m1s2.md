## Actividad 1: Identificación de scripts existentes
...
1. **Automatización de escaneo de vulnerabilidades con Nmap**
...
2. **Rotación y compresión de logs**
...
3. **Verificación de integridad de archivos (hashing)**
...
4. **Monitoreo de servicios en Linux (systemd)**
...
5. **Backup de configuraciones de dispositivos de red**
...
## Actividad 2: Desarrollo de un script en Python
