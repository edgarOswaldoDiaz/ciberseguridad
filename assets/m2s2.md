...
# Configurae diferentes máquinas virtuales según las necesidades del usuario, atendiendo la documentación del proveedor de la infraestructura de la nube; trabajando de forma autónoma y colaborativa, atendiendo las recomendaciones de su jefe inmediato.
---

## 1. Objetivos de Aprendizaje

* **Comprender** los conceptos de virtualización y los modelos de servicio en la nube (IaaS, PaaS, SaaS).
* **Aplicar** las guías y buenas prácticas provistas por el proveedor de la nube para el despliegue seguro de máquinas virtuales (VMs).
* **Diseñar** configuraciones de VM ajustadas a requisitos funcionales y de seguridad específicos de distintos perfiles de usuario (desarrollo, pruebas, producción).
* **Desarrollar** habilidades de autonomía y colaboración; integrar retroalimentación de su jefe inmediato para optimizar despliegues.
...
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **3.1 Selección de la imagen base**      | - Revisión de catálogos de imágenes oficiales (Linux, Windows, contenedores).<br>- Comparativa de versiones y niveles de soporte.                        |
| **3.2 Dimensionamiento de recursos**     | - Cálculo de CPU, RAM y disco según la carga esperada.<br>- Creación de un documento de especificaciones que valide con el jefe inmediato.               |
| **3.3 Configuración de red y seguridad** | - Diseño de subredes, grupos de seguridad / firewalls virtuales.<br>- Definición de reglas de entrada/salida; revisión con el equipo de redes.           |
| **3.4 Automatización del despliegue**    | - Uso de plantillas (CloudFormation, ARM, Terraform) para provisionar VMs.<br>- Validación de scripts en entornos de prueba.                             |
| **3.5 Personalización post‑arranque**    | - Instalación de agentes de monitoreo, antivirus y herramientas de gestión.<br>- Ejecución de scripts de arranque (cloud‑init, Custom Script Extension). |
| **3.6 Pruebas de funcionamiento**        | - Verificación de conectividad, rendimiento y políticas de acceso.<br>- Reporte de hallazgos y sugerencias de mejora al jefe inmediato.                  |
| **3.7 Documentación y entrega**          | - Elaboración de bitácora de pasos y capturas de pantalla.<br>- Presentación de la VM operativa y transferencia de conocimiento al equipo.               |

---

## Metodología de Trabajo

1. **Lectura y análisis de la documentación**
...
5. **Entrega y transferencia de conocimiento**
