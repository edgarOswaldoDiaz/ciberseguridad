...
A continuación encontrarás una descripción detallada del subtema **“Instala los sistemas operativos y servicios en la nube de acuerdo a las necesidades del usuario; trabajando de forma autónoma o colaborativa y atendiendo las recomendaciones de su jefe inmediato”**, organizada en cuatro secciones: 

---

## 1. Objetivo del subtema
...
## 2. Conocimientos y habilidades clave

| Categoría                                        | Contenido / Habilidad                                                                                     |
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------- |
| **Modelos de servicio en la nube**               | IaaS, PaaS, SaaS: diferencias, ventajas y casos de uso.                                                   |
| **Principales proveedores**                      | AWS EC2, Google Compute Engine, Azure Virtual Machines, Oracle Cloud, DigitalOcean, etc.                  |
| **Selección de SO y arquitecturas**              | Versiones de Linux (CentOS, Ubuntu, Debian), Windows Server, compatibilidad con aplicaciones y licencias. |
| **Automatización e Infraestructura como Código** | Uso de Terraform, CloudFormation, ARM Templates u otros.                                                  |
| **Seguridad y hardening**                        | Grupos de seguridad, firewalls, gestión de usuarios y privilegios, actualizaciones automatizadas.         |
| **Redes en la nube**                             | VPC/VNet, subredes, gateways, balanceadores, VPN y Direct Connect.                                        |
| **Colaboración y control de cambios**            | Git para scripts de despliegue, pull requests, revisión de pares, documentación de procedimientos.        |
| **Monitoreo y gestión**                          | CloudWatch, Stackdriver, Azure Monitor; alertas y dashboards.                                             |

---

## 3. Actividades y pasos recomendados
