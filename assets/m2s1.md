...
## Proceso de instalación del sistema operativo, considerando los requerimientos del usuario, la compatibilidad del hardware y software, atendiendo las recomendaciones del fabricante; trabajando de forma autónoma y colaborativa, cumpliendo con las recomendaciones de su jefe inmediato.![image](https://github.com/user-attachments/assets/a02fb4b1-efa0-421b-8e69-8476bd038371)
